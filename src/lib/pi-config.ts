 ...
 * is injected only into the spawned pi child, never into iyw-claw's own process.
 */
 ...
 *
 * iyw-claw's Settings skill store (Skills tab, Experts, Office tools) manages each
 ...
 * but not iyw-claw's process), so the skill store can't target it. Surfacing such
