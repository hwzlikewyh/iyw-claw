...
const CAPABILITY_ID_TO_TOOL: Readonly<Record<string, string>> = {
  ...
  "iyw.session.history.search.v1": "search_session_history",
  ...
  "iyw.memory.policy.read.v1": "read_memory_policy",
  ...
  "iyw.memory.candidates.list.v1": "list_user_memory_candidates",
  "iyw.memory.candidate.resolve.v1": "resolve_user_memory_candidate",
  "iyw.memory.candidate.delete.v1": "delete_user_memory_candidate",
  "iyw.memory.harvest.status.v1": "get_user_memory_harvest_status",
  "iyw.memory.harvest.rescan.v1": "rescan_user_memory_harvest",
