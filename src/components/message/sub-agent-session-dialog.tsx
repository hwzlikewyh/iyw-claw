 ...
 * the user's configured permission level), and the iyw-claw-mcp
...
function SubAgentSessionBody({
  ...
  // The child may also call the iyw-claw-mcp `ask_user_question` tool, raising the
