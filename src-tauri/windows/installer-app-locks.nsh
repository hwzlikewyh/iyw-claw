Function IywClawReportAppLocks
  ...
  nsExec::ExecToStack /TIMEOUT=15000 '"$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File "$PLUGINSDIR\iyw-app-locks.ps1" -AppDirectory "$IywClawAppDir" -ReleaseExplorer'
  Pop $R0
  Pop $R1
