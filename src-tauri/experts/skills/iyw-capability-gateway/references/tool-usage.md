...
| Upload files | upload_iyw_file with description + readable host file path, including outside the workspace; prefer an absolute path; optional name/mime_type; <=1 GiB, returns a public URL |
