...
pub const ENV_SUPERVISED: &str = "IYW_CLAW_SUPERVISED";
...
pub const ENV_RESTART_DELAY_MS: &str = "IYW_CLAW_RESTART_DELAY_MS";
...
pub const ENV_RUNTIME: &str = "IYW_CLAW_RUNTIME";

/// Default relaunch delay when `IYW_CLAW_RESTART_DELAY_MS` is unset.
...
pub const ENV_UPGRADE_TRIAL_SECS: &str = "IYW_CLAW_UPGRADE_TRIAL_SECS";

/// Default trial window when `IYW_CLAW_UPGRADE_TRIAL_SECS` is unset. A binary
