...
//! self-describing whether or not they end up wrapped in the `.iyw-clawbak`
//! envelope.
...
pub const BACKUP_KIND: &str = "iyw-claw-backup";
...
pub struct BackupPreview {
    /// The archive is wrapped in the encrypted `.iyw-clawbak` envelope.
    pub encrypted: bool,
