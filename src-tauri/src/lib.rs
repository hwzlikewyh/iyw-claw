...
mod tauri_app {
    ...
    use crate::commands::{
        ...
        session_info as session_info_commands, skill_inventory as skill_inventory_commands,
        skill_market as skill_market_commands, system_settings,
        system_skills as system_skills_commands, task_artifacts as task_artifact_commands,
        terminal as terminal_commands, usage as usage_commands,
