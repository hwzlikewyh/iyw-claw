...
pub fn build_router(
    ...
    let api = Router::new()
        ...
        .route(
            "/clear_user_memory",
            post(handlers::user_memory_entries::clear_user_memory),
        )
        .route(
        ...
        .route(
            "/upload_attachment",
            // `UPLOAD_MAX_BYTES` is the *file payload* limit; the
            ...
            // matching `DefaultBodyLimit` rejects a maximum-sized file
