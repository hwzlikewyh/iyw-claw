...
mod tests {
    ...
    // `IYW_CLAW_UPLOAD_MAX_TOTAL_BYTES` from a test would race the harness's
    // parallel runner.
    ...
    fn upload_quota_strict_error_display_includes_env_names_and_value() {
        ...
        assert!(msg.contains("IYW_CLAW_UPLOAD_MAX_TOTAL_BYTES"));
        assert!(msg.contains("IYW_CLAW_UPLOAD_QUOTA_STRICT"));
