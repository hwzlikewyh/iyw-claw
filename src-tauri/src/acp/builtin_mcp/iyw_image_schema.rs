...
fn parameters_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "keys": {"type": "array", "minItems": 1, "description": "classify-intent: known canvas context keys."},
