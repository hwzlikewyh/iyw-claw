...
const SPECIAL_METADATA: &[(&str, CapabilityIntentMetadata)] = &[
    ...
    ("browser_present", metadata!(&["present browser window", "展示浏览器窗口", "展示网页成果", "打开界面给用户看"], &["present", "展示", "browser", "浏览器", "window", "窗口", "ui", "界面"], "Compatibility alias for browser(action=present); present a managed page to the user.")),
