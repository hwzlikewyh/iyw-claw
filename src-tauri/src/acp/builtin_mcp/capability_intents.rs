...
const SPECIAL_METADATA: &[(&str, CapabilityIntentMetadata)] = &[
    ...
    ("browser", metadata!(&["browser", "使用浏览器", "打开网页并操作", "网页自动化"], &["browser", "浏览器", "web", "网页", "browse", "浏览", "automation", "自动化"], "Use the unified managed Chromix browser entry. The user must enable the built-in browser. Never launch an external browser or replay a retired external tab ID.")),
    ("browser_list_tabs", metadata!(&["list browser tabs", "列出浏览器标签页", "查看打开的网页"], &["list", "列出", "browser", "浏览器", "tab", "标签页"], "Compatibility alias for browser(action=list_tabs); lists only managed tabs available to this Agent when the built-in browser is enabled.")),
