...
pub struct AgentStorageReadGuard {
...
pub async fn begin_agent_storage_read() -> AgentStorageReadGuard {
    AgentStorageReadGuard {
        _guard: storage_work_lock().read_owned().await,
    }
}
