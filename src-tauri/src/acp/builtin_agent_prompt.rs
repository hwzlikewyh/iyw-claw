...
## Commercial-use and licensing reminder

For work that may be published or used commercially, unless the user clearly permits otherwise, prefer fonts, images, icons, audio/video, templates, code, and other materials with licenses that allow the intended use; when licensing is unclear, use a compliant alternative or placeholder when possible, and otherwise explain the risk and ask for confirmation without blocking non-commercial, internal-test, learning, or user-authorized work.
