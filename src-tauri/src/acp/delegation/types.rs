...
/// Per-agent defaults applied when iyw-claw-mcp spawns a subagent on behalf of a
...
///
/// `parent_connection_id` is the iyw-claw-internal ACP connection UUID for the
