...
/// `uploads_root/` directory past `IYW_CLAW_UPLOAD_MAX_TOTAL_BYTES`. The
/// per-file 100 MiB cap protects against one big payload; this cap
...
/// The file is not a iyw-claw backup, or its `format_version` is newer than this
/// binary understands.
