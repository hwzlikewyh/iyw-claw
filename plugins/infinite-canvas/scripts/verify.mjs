...
if (manifest.schemaVersion !== 2 || manifest.name !== "infinite-canvas" || manifest.version !== "0.1.8" || JSON.stringify(manifest.targets) !== JSON.stringify(["iyw-claw"])) throw new Error("plugin manifest identity is invalid")
