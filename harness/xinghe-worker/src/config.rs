...
const HOME_ENV: &str = "IYW_CLAW_XINGHE_WORKER_HOME";
const CWD_ENV: &str = "IYW_CLAW_XINGHE_WORKER_CWD";
const FINGERPRINT_ENV: &str = "IYW_CLAW_XINGHE_WORKER_FINGERPRINT";
const SESSION_ENV: &str = "IYW_CLAW_XINGHE_WORKER_EXPECTED_SESSION_ID";
const CONNECTION_ENV: &str = "IYW_CLAW_XINGHE_WORKER_CONNECTION_ID";
...
fn helper_executable() -> Result<PathBuf, ConfigError> {
    let path = std::env::var_os("IYW_CLAW_XINGHE_WORKER_HELPER")
        .map(PathBuf::from)
