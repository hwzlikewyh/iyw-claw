...
- [ ] **Step 1: 定义 scene 和 operation 类型**
...
- Create: `plugins/infinite-canvas/dist/infinite-canvas-0.1.0.zip`

**Interfaces:**
- Produces: deterministic ZIP、SHA-256、文件清单和 verifier receipt。

- [ ] **Step 1: bundle runtime**
...
- [ ] **Step 2: 实现 deterministic package**
...
Expected: 全部 exit 0；打印 artifact size、SHA-256、9 tools、1 resource、0 tldraw matches。
