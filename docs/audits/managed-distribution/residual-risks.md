...
| ticker 无持久状态/租约/重试/死信 | IYW-JOB-001 | T02 | Wave 1 | confirmed；031 已随 7b1c0a8 提交，jobcenter 实现未合并 |
...
| 桌面包携带运行时/Skill、直连上游 | IYW-DIST-001 | T05/T06 | Wave 1/2 | confirmed；工作区包已瘦身（部分），直连上游仍在 |
